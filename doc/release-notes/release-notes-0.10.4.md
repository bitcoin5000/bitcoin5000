Bitcoin5000 Core version 0.10.4 is now available from:

  <https://bitcoin5000.org/bin/bitcoin5000-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoin5000-tx into its own package
- #6953 `dfe0d4d` Include bitcoin5000-tx binary on Debian/Ubuntu
