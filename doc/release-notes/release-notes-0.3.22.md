Download URL: https://sourceforge.net/projects/bitcoin5000/files/Bitcoin5000/bitcoin5000-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BVK fee schedule (users still pay 0.01 BVK per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoin500000 - #bitcoin500099
