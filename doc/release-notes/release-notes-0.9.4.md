Bitcoin5000 Core version 0.9.4 is now available from:

  https://bitcoin5000.org/bin/0.9.4/
...
this update is incompatible with the Bitcoin5000 system and could lead to consensus
forks.

Bitcoin5000 Core released binaries from https://bitcoin5000.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoin5000/+archive/ubuntu/bitcoin5000
- A third-party or self-compiled Bitcoin5000 Core

upgrade to Bitcoin5000 Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
