Bitcoin5000 Core version 0.13.1 is now available from:

  <https://bitcoin5000.org/bin/bitcoin5000-core-0.13.1/>
...
updates will be released anymore. Without security updates, using a bitcoin5000
wallet on a XP machine is irresponsible at least.

In addition to that, with 0.12.x there have been varied reports of Bitcoin5000 Core
randomly crashing on Windows XP. It is [not clear](https://github.com/bitcoin5000/bitcoin5000/issues/7681#issuecomment-217439891)
...
- **Elimination of unwanted transaction malleability:** Segregating the witness
  ...
  malleability, which is a problem that makes programming Bitcoin5000 wallet
  software more difficult and which seriously complicates the design of smart
  contracts for Bitcoin5000.
...
- **Weighting data based on how it affects node performance:** Some parts of
  each Bitcoin5000 block need to be stored by nodes in order to validate future
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of bitcoin5000s they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of bitcoin5000s being spent is exactly
...
- **Increased security for multisig:** Bitcoin5000 addresses (both P2PKH addresses
  ...
  believed to be provided by Bitcoin5000's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  Bitcoin5000 paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of Bitcoin5000's current ledger (called the UTXO set),
  ...
  note that Bitcoin5000 Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Bitcoin5000 users to individually opt-in to almost any change in the Bitcoin5000
  Script language when those users receive new transactions.  Features
  currently being researched by Bitcoin5000 Core contributors that may use this
  capability include support for Schnorr signatures, which can improve the
  privacy and efficiency of multisig transactions (or transactions with
  multiple inputs), and Merklized Abstract Syntax Trees (MAST), which can
  improve the privacy and efficiency of scripts with two or more conditions.
  Other Bitcoin5000 community members are studying several other improvements
...
[Segwit FAQ]: https://bitcoin5000core.org/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://bitcoin5000core.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/bitcoin5000/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/bitcoin5000/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/bitcoin5000/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/bitcoin5000/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://bitcoin5000core.org/en/2016/06/08/version-bits-miners-faq/
...
Since Bitcoin5000 Core 0.10.0, nodes have defaulted to only relaying and
...
[BIP147]: https://github.com/bitcoin5000/bips/blob/master/bip-0147.mediawiki
...
- `bitcoin5000-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries targeting
  the 32-bit ARMv7-A architecture.
- `bitcoin5000-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries targeting
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in bitcoin5000consensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.bitcoin5000stats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libbitcoin5000consensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_bitcoin5000 by itself (luke-jr)
...
- #8829 `2a8bca4` Add bitcoin5000-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` bitcoin5000-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_bitcoin5000ds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name bitcoin5000.qrc  (bitcoin5000sSG)
...
- #8817 `bcf3806` update bitcoin5000-tx to output witness data (jnewbery)
