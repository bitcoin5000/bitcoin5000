Bitcoin5000 version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin5000/files/Bitcoin5000/bitcoin5000-0.5.4/
...
http://gitorious.org/bitcoin5000/bitcoin5000d-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcoin5000-Qt notifications under Growl 1.3.
Increase required age of Bitcoin5000-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin5000 properly when installing Bitcoin5000-Qt over it. (Windows)
