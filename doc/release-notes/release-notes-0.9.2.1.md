Bitcoin5000 Core version 0.9.2.1 is now available from:

  https://bitcoin5000.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BVK to 0.01 BVK
...
- Fix "Start bitcoin5000 on system login"
