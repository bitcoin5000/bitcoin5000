Bitcoin5000 Core version 0.13.2 is now available from:

  <https://bitcoin5000.org/bin/bitcoin5000-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoin5000-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoin5000-tx to create v2 transactions (btcdrak)
