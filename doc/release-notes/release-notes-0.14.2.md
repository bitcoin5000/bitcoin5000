Bitcoin5000 Core version 0.14.2 is now available from:

  <https://bitcoin5000.org/bin/bitcoin5000-core-0.14.2/>
...
(in Bitcoin5000 Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Bitcoin5000-Qt when using coin
...
- #10228 `ae479bc` Regenerate bitcoin5000-config.h as necessary (theuni)
