Bitcoin5000 version 0.7.2 is now available from:
  http://sourceforge.net/projects/bitcoin5000/files/Bitcoin5000/bitcoin5000-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Bitcoin5000-Qt to crash on Windows when exiting.
