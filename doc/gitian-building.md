...
*Setup instructions for a Gitian build of Bitcoin5000 Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Bitcoin5000
...
- [Building Bitcoin5000 Core](#building-bitcoin5000-core)
...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-bitcoin5000-host/README.md).
...
Clone the git repositories for bitcoin5000 and Gitian.
...
in the bitcoin5000 repository under 'Fetch and create inputs' to install sources which require
manual intervention. Also optionally follow the next step: 'Seed the Gitian sources cache
and offline git repositories' which will fetch the remaining files required for building
offline.

Building Bitcoin5000 Core
----------------

To build Bitcoin5000 Core (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the bitcoin5000 repository.
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/bitcoin5000/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/bitcoin5000/bitcoin5000
...
For example:
```bash
URL=https://github.com/laanwj/bitcoin5000.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit bitcoin5000=${COMMIT} --url bitcoin5000=${URL} ../bitcoin5000/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit bitcoin5000=${COMMIT} --url bitcoin5000=${URL} ../bitcoin5000/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit bitcoin5000=${COMMIT} --url bitcoin5000=${URL} ../bitcoin5000/contrib/gitian-descriptors/gitian-osx.yml
```
...
and the bitcoin5000 git repository with the desired tag must both be available locally, and then gbuild must be
...
LXC_ARCH=amd64 LXC_SUITE=trusty on-target -u root \
  ...
  $( sed -ne '/^packages:/,/[^-] .*/ {/^- .*/{s/"//g;s/- //;p}}' ../bitcoin5000/contrib/gitian-descriptors/*|sort|uniq )
...
BVKPATH=/some/root/path/bitcoin5000
SIGPATH=/some/root/path/bitcoin5000-detached-sigs

./bin/gbuild --url bitcoin5000=${BVKPATH},signature=${SIGPATH} ../bitcoin5000/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/bitcoin5000-linux-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/bitcoin5000-win-build.assert
    gpg --detach-sign ${VERSION}-osx-unsigned/${SIGNER}/bitcoin5000-osx-build.assert
```
...
[bitcoin5000-core/gitian.sigs](https://github.com/bitcoin5000-core/gitian.sigs/) repository, or if that's not possible create a pull
