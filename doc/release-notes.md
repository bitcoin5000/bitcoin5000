Bitcoin5000 Core version *0.15.2* is now available from:

  <https://bitcoin5000core.org/bin/bitcoin5000-core-0.15.2/>

or

  <https://bitcoin5000.org/bin/bitcoin5000-core-0.15.2/>
...
Bitcoin5000 Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #11554 `a69cc07` Sanity-check script sizes in bitcoin5000-tx (TheBlueMatt)
