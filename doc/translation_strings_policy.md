...
This document provides guidelines for internationalization of the Bitcoin5000 Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoin5000_en.ts` remains unchanged.
