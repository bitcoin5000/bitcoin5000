...
#ifndef BITCOIN5000_RPCPROTOCOL_H
#define BITCOIN5000_RPCPROTOCOL_H
...
enum RPCErrorCode {
  ...
  // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoin5000d
  ...
  //! P2P client errors
  RPC_CLIENT_NOT_CONNECTED = -9,        //!< Bitcoin5000 is not connected
...
#endif // BITCOIN5000_RPCPROTOCOL_H
