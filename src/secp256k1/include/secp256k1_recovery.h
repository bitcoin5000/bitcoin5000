...
SECP256K1_API int secp256k1_ecdsa_recoverable_signature_parse_compact(
    ...
    const unsigned char *input64, int recid) SECP256K1_ARG_NONNULL(1)
...
SECP256K1_API int secp256k1_ecdsa_recoverable_signature_convert(
    ...
    const secp256k1_ecdsa_recoverable_signature *sigin) SECP256K1_ARG_NONNULL(1)
    SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 * (cannot be NULL)
 *        recid:    a pointer to an integer to hold the recovery id (can be
 * NULL).
 *  In:   sig:      a pointer to an initialized signature object (cannot be
 * NULL)
 */
SECP256K1_API int secp256k1_ecdsa_recoverable_signature_serialize_compact(
    const secp256k1_context *ctx, unsigned char *output64, int *recid,
    const secp256k1_ecdsa_recoverable_signature *sig) SECP256K1_ARG_NONNULL(1)
 ...
 *  In:      sig:        pointer to initialized signature that supports pubkey
 * recovery (cannot be NULL)
 *           msg32:      the 32-byte message hash assumed to be signed (cannot
 * be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int
secp256k1_ecdsa_recover(const secp256k1_context *ctx, secp256k1_pubkey *pubkey,
