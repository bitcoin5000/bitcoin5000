 ...
 * Multiplies the magnitude by that
 *  small integer. */
 ...
 * inputs' magnitudes to be
 *  at most 8. The output magnitudes are 1 (but not guaranteed to be
 * normalized). The inputs and
