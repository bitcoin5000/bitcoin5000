...
AES128Encrypt::~AES128Encrypt() { memset(&ctx, 0, sizeof(ctx)); }
...
AES128Decrypt::~AES128Decrypt() { memset(&ctx, 0, sizeof(ctx)); }
...
AES256Encrypt::~AES256Encrypt() { memset(&ctx, 0, sizeof(ctx)); }
...
AES256Decrypt::~AES256Decrypt() { memset(&ctx, 0, sizeof(ctx)); }
...
AES256CBCEncrypt::~AES256CBCEncrypt() { memset(iv, 0, sizeof(iv)); }
...
AES256CBCDecrypt::~AES256CBCDecrypt() { memset(iv, 0, sizeof(iv)); }
...
AES128CBCEncrypt::~AES128CBCEncrypt() { memset(iv, 0, AES_BLOCKSIZE); }
...
AES128CBCDecrypt::~AES128CBCDecrypt() { memset(iv, 0, AES_BLOCKSIZE); }
