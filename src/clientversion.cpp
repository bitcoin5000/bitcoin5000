 ...
 * for both bitcoin5000d and bitcoin5000-core, to make it harder for attackers
 * to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Bitcoin5000");
 ...
 * (https://github.com/bitcoin5000/bips/blob/master/bip-0014.mediawiki)
 */
