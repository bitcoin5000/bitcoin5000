...
#ifndef BITCOIN5000_CHAINPARAMS_H
#define BITCOIN5000_CHAINPARAMS_H
 ...
 * Bitcoin5000 system. There are three: the main network on which people trade
 * goods
...
#endif // BITCOIN5000_CHAINPARAMS_H
