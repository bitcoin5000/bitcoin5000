...
class CBitcoin5000LevelDBLogger : public leveldb::Logger {
public:
  ...
  virtual void Logv(const char *format, va_list ap) override {
    ...
    for (int iter = 0; iter < 2; iter++) {
      ...
      if (p < limit) {
        ...
        // Do not use vsnprintf elsewhere in bitcoin5000 source code, see above.
...
static leveldb::Options GetOptions(size_t nCacheSize) {
  ...
  options.info_log = new CBitcoin5000LevelDBLogger();
