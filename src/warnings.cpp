...
std::string GetWarnings(const std::string &strFor) {
  ...
  if (!CLIENT_VERSION_IS_RELEASE) {
    strStatusBar = "This is a pre-release test build - use at your own risk - "
                   "do not use for mining or merchant applications";
    strGUI = _("This is a pre-release test build - use at your own risk - do "
  ...
  if (fLargeWorkForkFound) {
    ...
    strStatusBar = strRPC = "Warning: We do not appear to fully agree with our "
                            "peers! You may need to upgrade, or other nodes "
                            "may need to upgrade.";
    strGUI += (strGUI.empty() ? "" : uiAlertSeperator) +
