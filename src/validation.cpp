...
#if defined(NDEBUG)
#error "Bitcoin5000 cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Bitcoin5000 Signed Message:\n";
...
static bool AcceptToMemoryPoolWorker(
...

  {
    ...
    for (const CTxMemPool::txiter it : allConflicting) {
      LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BVK additional "
                               "fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
  RenameThread("bitcoin5000-scriptch");
