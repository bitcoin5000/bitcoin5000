...
#ifndef BITCOIN5000_ARITH_UINT256_H
#define BITCOIN5000_ARITH_UINT256_H
...
public:
   ...
   *
   * Bitcoin5000 only uses this "compact" format for encoding difficulty
...
#endif // BITCOIN5000_ARITH_UINT256_H
