...
#ifndef BITCOIN5000_HASH_H
#define BITCOIN5000_HASH_H
...
/** A hasher class for Bitcoin5000's 256-bit hash (double SHA-256). */
class CHash256 {
private:
  CSHA256 sha;
...
/** A hasher class for Bitcoin5000's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
  CSHA256 sha;
