...
BOOST_AUTO_TEST_CASE(netbase_splithost) {
  BOOST_CHECK(TestSplitHost("www.bitcoin5000.org", "www.bitcoin5000.org", -1));
  BOOST_CHECK(
      TestSplitHost("[www.bitcoin5000.org]", "www.bitcoin5000.org", -1));
  BOOST_CHECK(
      TestSplitHost("www.bitcoin5000.org:80", "www.bitcoin5000.org", 80));
  BOOST_CHECK(
      TestSplitHost("[www.bitcoin5000.org]:80", "www.bitcoin5000.org", 80));
