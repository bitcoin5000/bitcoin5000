...
#ifndef BITCOIN5000_TEST_SCRIPTNUM10_H
#define BITCOIN5000_TEST_SCRIPTNUM10_H
...
class CScriptNum10 {
  /**
   * The ScriptNum implementation from Bitcoin5000 Core 0.10.0, for
   * cross-comparison.
   */
public:
...
#endif // BITCOIN5000_TEST_BIGNUM_H
