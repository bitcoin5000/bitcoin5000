...
#ifndef BITCOIN5000_WALLET_WALLET_H
#define BITCOIN5000_WALLET_WALLET_H
...
public:
   ...
   * on this bitcoin5000 node, and set to 0 for transactions that were created
...
#endif // BITCOIN5000_WALLET_WALLET_H
