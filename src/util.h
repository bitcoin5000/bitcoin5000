 ...
 */
#ifndef BITCOIN5000_UTIL_H
#define BITCOIN5000_UTIL_H
...
extern const char *const BITCOIN5000_CONF_FILENAME;
extern const char *const BITCOIN5000_PID_FILENAME;
...
template <typename Callable> void TraceThread(const char *name, Callable func) {
  std::string s = strprintf("bitcoin5000-%s", name);
