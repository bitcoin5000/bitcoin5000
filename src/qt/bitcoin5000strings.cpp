...
#define UNUSED
#endif
static const char UNUSED *bitcoin5000_strings[] = {
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Bitcoin5000 Core"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "The %s developers"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      ""
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "%s corrupt, salvage failed"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "%s is set very high!"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "(default: %s)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "(default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "(press q to shutdown and continue later)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "-maxmempool must be at least %d MB"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "<category> can be:"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Accept command line and JSON-RPC commands"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Accept connections from outside "
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Block creation options:"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Cannot downgrade wallet"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Cannot resolve -%s address: '%s'"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Cannot write default address"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Chain selection options:"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Change index out of range"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Connect through SOCKS5 proxy"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Connect to a node to retrieve peer addresses, and disconnect"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Connection options:"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Copyright (C) %i-%i"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Corrupted block database detected"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Debugging/Testing options:"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Do not load the wallet and disable wallet RPC calls"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Do you want to rebuild the block database now?"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Done loading"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Error initializing block database"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Error initializing wallet database environment %s!"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Error loading %s"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Error loading %s: Wallet corrupted"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Error loading %s: Wallet requires newer version of %s"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Error loading %s: You can't disable "
                                          "HD on an already existing HD "
                                          "wallet"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Error loading block database"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Error opening block database"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Error reading from database, shutting down."),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Error upgrading chainstate database"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Error"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Error: A fatal internal error occurred, see debug.log for details"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Error: Disk space is low!"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Importing..."),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Information"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Initialization sanity check failed. %s is shutting down."),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Insufficient funds"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Listen for JSON-RPC connections on "
                                          "<port> (default: %u or testnet: "
                                          "%u)"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Listen for connections on <port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Loading P2P addresses..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Loading banlist..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Loading block index..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Loading wallet..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Node relay options:"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Not enough file descriptors available."),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Options:"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Password for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Prepend debug output with timestamp (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Print this help message and exit"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Print version and exit"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Prune cannot be configured with a negative value."),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Prune mode is incompatible with -txindex."),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Pruning blockstore..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "RPC server options:"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Rebuild chain state and block index from the blk*.dat files on disk"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Rebuild chain state from the currently indexed blocks"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Reducing -maxconnections from %d to "
                                          "%d, because of system limitations."),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Relay and mine data carrier transactions (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Relay non-P2SH multisig (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Replaying blocks..."),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Rescan the block chain for missing wallet transactions on startup"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Rescanning..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Rewinding blocks..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Signing transaction failed"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Specify configuration file (default: %s)"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Specify data directory"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Specify pid file (default: %s)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Specify wallet file (within data directory)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Specify your own public address"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Spend unconfirmed change when sending transactions (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Starting network threads..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "This is experimental software."),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Transaction amount too small"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Transaction too large"),
    QT_TRANSLATE_NOOP(
        "bitcoin5000-core",
        "Unable to bind to %s on this computer (bind returned error %s)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Unable to bind to %s on this "
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Upgrading UTXO database"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Use UPnP to map the listening port (default: %u)"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Use the test chain"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "User Agent comment (%s) contains unsafe characters."),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Username for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Verifying blocks..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Verifying wallet(s)..."),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Wallet %s resides outside data directory %s"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Wallet debugging/testing options:"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
                      "Wallet needed to be rewritten: restart %s to complete"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Wallet options:"),
    QT_TRANSLATE_NOOP("bitcoin5000-core", "Warning"),
    QT_TRANSLATE_NOOP("bitcoin5000-core",
    ...
    QT_TRANSLATE_NOOP("bitcoin5000-core", "ZeroMQ notification options:"),
};
