...
TransactionTableModel::TransactionTableModel(
  ...
  columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label")
          << Bitcoin5000Units::getAmountColumnTitle(
...
void TransactionTableModel::updateAmountColumnTitle() {
  columns[Amount] = Bitcoin5000Units::getAmountColumnTitle(
      walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(
    ...
    Bitcoin5000Units::SeparatorStyle separators) const {
  QString str =
      Bitcoin5000Units::format(walletModel->getOptionsModel()->getDisplayUnit(),
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const {
  ...
  case Qt::DisplayRole:
    ...
    case Amount:
      return formatTxAmount(rec, true, Bitcoin5000Units::separatorAlways);
    }
    break;
  case Qt::EditRole:
  ...
  case TxPlainTextRole: {
    ...
    details.append(
        formatTxAmount(rec, false, Bitcoin5000Units::separatorNever));
    return details;
  }
  case ConfirmedRole:
  ...
  case FormattedAmountRole:
    ...
    return formatTxAmount(rec, false, Bitcoin5000Units::separatorNever);
  case StatusRole:
