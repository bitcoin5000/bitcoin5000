...
#ifndef BITCOIN5000_QT_BITCOIN5000UNITS_H
#define BITCOIN5000_QT_BITCOIN5000UNITS_H
...
/** Bitcoin5000 unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class Bitcoin5000Units : public QAbstractListModel {
  Q_OBJECT

public:
  explicit Bitcoin5000Units(QObject *parent);

  /** Bitcoin5000 units.
    @note Source: https://en.bitcoin5000.it/wiki/Units . Please add only
    sensible ones
   */
  enum Unit { BVK, mBVK, uBVK };
...
typedef Bitcoin5000Units::Unit Bitcoin5000Unit;

#endif // BITCOIN5000_QT_BITCOIN5000UNITS_H
