...
#include "qt/bitcoin5000amountfield.h"
...
#include "test/test_bitcoin5000.h"
...
uint256 SendCoins(CWallet &wallet, SendCoinsDialog &sendCoinsDialog,
                  const CBitcoin5000Address &address, CAmount amount,
                  bool rbf) {
  ...
  entry->findChild<Bitcoin5000AmountField *>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_bitcoin5000-qt -platform xcb      # Linux
//     src/qt/test/test_bitcoin5000-qt -platform windows  # Windows
//     src/qt/test/test_bitcoin5000-qt -platform cocoa    # macOS
void TestSendCoins() {
  ...
  uint256 txid1 =
      SendCoins(wallet, sendCoinsDialog, CBitcoin5000Address(CKeyID()),
                5 * COIN, false /* rbf */);
  uint256 txid2 =
      SendCoins(wallet, sendCoinsDialog, CBitcoin5000Address(CKeyID()),
                10 * COIN, true /* rbf */);
