...
#ifndef BITCOIN5000_QT_BITCOIN5000AMOUNTFIELD_H
#define BITCOIN5000_QT_BITCOIN5000AMOUNTFIELD_H
...
/** Widget for entering bitcoin5000 amounts.
  */
class Bitcoin5000AmountField : public QWidget {
  Q_OBJECT

  // ugly hack: for some unknown reason CAmount (instead of qint64) does not
  // work here as expected
  // discussion: https://github.com/bitcoin5000/bitcoin5000/pull/5117
  Q_PROPERTY(
      qint64 value READ value WRITE setValue NOTIFY valueChanged USER true)

public:
  explicit Bitcoin5000AmountField(QWidget *parent = 0);
...
#endif // BITCOIN5000_QT_BITCOIN5000AMOUNTFIELD_H
