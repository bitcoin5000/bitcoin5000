...
public:
  TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent = nullptr)
      : QAbstractItemDelegate(parent), unit(Bitcoin5000Units::BVK),
  ...
  inline void paint(QPainter *painter, const QStyleOptionViewItem &option,
    ...
    painter->setPen(foreground);
    QString amountText = Bitcoin5000Units::formatWithUnit(
        unit, amount, true, Bitcoin5000Units::separatorAlways);
    if (!confirmed) {
...
void OverviewPage::setBalance(const CAmount &balance,
  ...
  ui->labelBalance->setText(Bitcoin5000Units::formatWithUnit(
      unit, balance, false, Bitcoin5000Units::separatorAlways));
  ui->labelUnconfirmed->setText(Bitcoin5000Units::formatWithUnit(
      unit, unconfirmedBalance, false, Bitcoin5000Units::separatorAlways));
  ui->labelImmature->setText(Bitcoin5000Units::formatWithUnit(
      unit, immatureBalance, false, Bitcoin5000Units::separatorAlways));
  ui->labelTotal->setText(Bitcoin5000Units::formatWithUnit(
      unit, balance + unconfirmedBalance + immatureBalance, false,
      Bitcoin5000Units::separatorAlways));
  ui->labelWatchAvailable->setText(Bitcoin5000Units::formatWithUnit(
      unit, watchOnlyBalance, false, Bitcoin5000Units::separatorAlways));
  ui->labelWatchPending->setText(Bitcoin5000Units::formatWithUnit(
      unit, watchUnconfBalance, false, Bitcoin5000Units::separatorAlways));
  ui->labelWatchImmature->setText(Bitcoin5000Units::formatWithUnit(
      unit, watchImmatureBalance, false, Bitcoin5000Units::separatorAlways));
  ui->labelWatchTotal->setText(Bitcoin5000Units::formatWithUnit(
...
void OverviewPage::setWalletModel(WalletModel *model) {
  ...
  // update the display unit, to not use the default ("BVK")
  updateDisplayUnit();
}
