...
/* Window elements init */
  ...
  ui->bitcoin5000AtStartup->setToolTip(
      ui->bitcoin5000AtStartup->toolTip().arg(tr(PACKAGE_NAME)));
  ui->bitcoin5000AtStartup->setText(
      ui->bitcoin5000AtStartup->text().arg(tr(PACKAGE_NAME)));

  ui->openBitcoin5000ConfButton->setToolTip(
      ui->openBitcoin5000ConfButton->toolTip().arg(tr(PACKAGE_NAME)));
  ...
  ui->unit->setModel(new Bitcoin5000Units(this));
...
void OptionsDialog::setMapper() {
  /* Main */
  mapper->addMapping(ui->bitcoin5000AtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoin5000ConfButton_clicked() {
  ...
  if (!GUIUtil::openBitcoin5000Conf())
