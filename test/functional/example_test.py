...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the Bitcoin5000TestFramework
    pass

class ExampleTest(Bitcoin5000TestFramework):
    # Each functional test is a subclass of the Bitcoin5000TestFramework class.
    ...
    def custom_method(self):
        ...
        Bitcoin5000TestFramework class so other tests can use it."""
