...
from test_framework.test_framework import Bitcoin5000TestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (Bitcoin5000TestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bitcoin5000 has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bitcoin5000d has not been built with zmq enabled.")
