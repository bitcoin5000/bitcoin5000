...
# TestNode: A peer we use to send messages to bitcoin5000d, and store responses.
...
class CompactBlocksTest(Bitcoin5000TestFramework):
    ...
    # This test actually causes bitcoin5000d to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoin5000d's choice of nonce.
    ...
    # Test that bitcoin5000d requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoin5000d to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoin5000d will not send blocktxn responses for blocks whose height is
