...
Also test that nodes that send unsupported service bits to bitcoin5000d are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if bitcoin5000d ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(Bitcoin5000TestFramework):
