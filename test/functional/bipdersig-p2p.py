...
class BIP66Test(Bitcoin5000TestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoin5000d is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoin5000d produces more specific reject
            # reasons.
